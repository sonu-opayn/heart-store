...
class ApiResponse extends Response 
{
	...
	public static function validation ($validator, $stringify=false, $status='412', $headers=array() ) {
		...
		return self::json( array('messages' => $response, 'message' => $message), $status, $headers);
	}
	...
	{
		return self::json(['data' => $data, 'message' => $message], $code, $headers);
	}
	...
	{
		return self::json(['message' => $message], $code, $headers);
	}
}